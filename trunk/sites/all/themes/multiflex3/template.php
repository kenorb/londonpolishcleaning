 ...
 *   entirety and paste it here, changing the prefix from theme_ to multiflex3_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: multiflex3_breadcrumb()
 *
 *   where multiflex3 is the name of your sub-theme. For example, the
 ...
 */
function multiflex3_preprocess_html(&$variables, $hook) {
  $directory = drupal_get_path('theme', 'multiflex3') . '/css/';
  ...
  if (file_exists($directory . 'custom.css')) {
    drupal_add_css($directory . 'custom.css', array('group' => CSS_THEME, 'every_page' => TRUE));
  }
}
...
function multiflex3_preprocess_page(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function multiflex3_preprocess_node(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');

  // Optionally, run node-type-specific preprocess functions, like
  // multiflex3_preprocess_node_page() or multiflex3_preprocess_node_story().
 ...
 */
/* -- Delete this line if you want to use this function
function multiflex3_preprocess_comment(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function multiflex3_preprocess_block(&$variables, $hook) {
 ...
 */
function multiflex3_preprocess_region(&$variables, $hook) {
  ...
  else if (strpos($variables['region'], 'triptych_') === 0) {
    $variables['classes_array'][] = 'column';
    $variables['classes_array'][] = 'triptych';
    $variables['theme_hook_suggestions'][] = 'region__triptych';
    // Allow a region-specific template to override Zen's region--triptych.
    $variables['theme_hook_suggestions'][] = 'region__' . $variables['region'];
  }
  else if (strpos($variables['region'], 'footer_') === 0) {
    $variables['classes_array'][] = 'column';
